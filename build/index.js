...
var DeviceWidget = /** @class */ (function (_super) {
    ...
    DeviceWidget.prototype.render = function () {
        return (React__default.createElement("div", null,
            React__default.createElement("div", { className: this.state.widgetExpanded ? "DeviceWidgetExpand" : "DeviceWidgetExpand closed" }, this.state.widgetExpanded ? (React__default.createElement("div", { className: "DeviceWidgetExpand-icon", onClick: this.toggleWidgetExpanded },
                React__default.createElement(FontAwesomeIcon, { icon: "compress-alt" }))) : (React__default.createElement("div", { className: "DeviceWidgetExpand-icon", onClick: this.toggleWidgetExpanded },
