...
var DeviceWidget = /** @class */ (function (_super) {
    ...
    DeviceWidget.prototype.render = function () {
        return (React__default.createElement("div", null,
            ...
            React__default.createElement("div", { className: this.state.widgetExpanded ? "DeviceWidgetExpand" : "DeviceWidgetExpand closed" }, this.state.widgetExpanded ? (React__default.createElement("button", { className: "DeviceWidgetExpand-icon", onClick: this.toggleWidgetExpanded },
                React__default.createElement(FontAwesomeIcon, { icon: "compress-alt" }))) : (React__default.createElement("button", { className: "DeviceWidgetExpand-icon", onClick: this.toggleWidgetExpanded },
                React__default.createElement(FontAwesomeIcon, { icon: "expand-alt" })))),
            React__default.createElement("div", { className: this.state.widgetExpanded === true ? "TS-fgReact_componentContainer" : "TS-fgReact_componentContainer closed" }, this.state.widgetExpanded === true ? (React__default.createElement("div", { className: "d-flex" },
                React__default.createElement("div", { className: this.state.breadCrumbsExpanded === true ? "DeviceWidget-section DeviceWidget-section-breadCrumb" : "DeviceWidget-section DeviceWidget-section-breadCrumb closed" },
                    React__default.createElement("h5", null, "Hierarchy")),
                React__default.createElement("div", { className: this.state.detailsExpanded === true ? "DeviceWidget-section DeviceWidget-section-details" : "DeviceWidget-section DeviceWidget-section-details closed" },
                    React__default.createElement("h5", null, "Details")),
                React__default.createElement("div", { className: this.state.mapExpanded === true ? "DeviceWidget-section DeviceWidget-section-map" : "DeviceWidget-section DeviceWidget-section-map closed" },
                    React__default.createElement("h5", null, "Map")))) : (""))));
    };
    return DeviceWidget;
}(React.Component));
