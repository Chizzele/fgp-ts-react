        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: this.state.widgetExpanded === true ? "TS-fgReact_componentContainer" : "TS-fgReact_componentContainer closed" }, this.state.widgetExpanded === true ? (React.createElement("div", { className: "d-flex" },
                React.createElement("div", { className: this.state.breadCrumbsExpanded === true ? "DeviceWidget-section DeviceWidget-section-breadCrumb" : "DeviceWidget-section DeviceWidget-section-breadCrumb closed" },
                    React.createElement("h5", null, "Hierarchy")),
                React.createElement("div", { className: this.state.detailsExpanded === true ? "DeviceWidget-section DeviceWidget-section-details" : "DeviceWidget-section DeviceWidget-section-details closed" },
                    React.createElement("h5", null, "Details")),
                React.createElement("div", { className: this.state.mapExpanded === true ? "DeviceWidget-section DeviceWidget-section-map" : "DeviceWidget-section DeviceWidget-section-map closed" },
                    React.createElement("h5", null, "Map")))) : (""))));
    };
    return DeviceWidget;
}(Component));
