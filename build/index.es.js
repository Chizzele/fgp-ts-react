    ...
    DeviceWidget.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            this.state.topTabs.length > 1 ? (React.createElement("div", { className: this.state.widgetExpanded ? "DeviceWidgetExpand" : "DeviceWidgetExpand closed" }, this.state.topTabs.map(function (tab, index) {
                React.createElement("button", { className: "DeviceWidgetExpand-icon viewTabs", onClick: _this.zoomOutHandler, disabled: false, style: { "left": index * 20 + "px" } }, tab.title);
                ...
                React.createElement("button", { className: "DeviceWidgetExpand-icon viewTabs", onClick: this.zoomOutHandler, disabled: true, style: { "left": "130px" } }, "Second View"))),
            ...
            React.createElement("div", { className: this.state.widgetExpanded === true ? "TS-fgReact_componentContainer" : "TS-fgReact_componentContainer closed" }, this.state.widgetExpanded === true ? (React.createElement("div", { className: "d-flex w-100" },
                ...
                React.createElement("div", { className: this.state.detailsExpanded === true ? "DeviceWidget-section DeviceWidget-section-details DeviceWidget-section-border" : "DeviceWidget-section DeviceWidget-section-details closed DeviceWidget-section-border" },
                    ...
                    "details"),
                React.createElement("div", { className: this.state.mapExpanded === true ? "DeviceWidget-section DeviceWidget-section-map" : "DeviceWidget-section DeviceWidget-section-map closed" }, "map here"))) : ("Im collapsed"))));
    };
    return DeviceWidget;
}(Component));
