...
import { faCheckSquare, faCoffee, faWifi, faSpinner, faExpandAlt, faCompressAlt} from '@fortawesome/free-solid-svg-icons'
...
library.add(fab, faCheckSquare, faCoffee, faWifi, faSpinner, faExpandAlt, faCompressAlt);
export { 
    TestComponent,
    AutoComplete,
    MonitorApi,
