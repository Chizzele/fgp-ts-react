...
import { faCheckSquare, faCoffee, faWifi, faSpinner, faExpandAlt, faCompressAlt, faSearchPlus, faSearchMinus} from '@fortawesome/free-solid-svg-icons'
...
library.add(fab, faCheckSquare, faCoffee, faWifi, faSpinner, faExpandAlt, faCompressAlt, faSearchPlus, faSearchMinus);
export { 
    TestComponent,
    AutoComplete,
    MonitorApi,
