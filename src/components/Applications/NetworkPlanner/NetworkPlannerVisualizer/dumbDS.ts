...
export default class DumbDS implements DataHandler {
    source : string;
    // baseUrl : string;
    ...
    constructor(substationId:string, rowIndex:number, deviceType:string , cb:(data:{substationId : string, rowIndex : number, data : [], timeWindow:number[], deviceType:string}) => void){
