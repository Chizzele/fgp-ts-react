...
export default class WidgetDataProcessor {
  ...
  getRedirect(key:string, value:any) {
  ...
  cleanRelationshipData (data:CleanedExtensionDataForProcessor[]) {
  ...
  relationshipExclude (data:CleanedExtensionDataForProcessor[]) {
  ...
  relationshipRename(point:CleanedExtensionDataForProcessor) {
  ...
  relationshipFormat(point:CleanedExtensionDataForProcessor) {
    //
  ...
  relationshipRedirect(point:CleanedExtensionDataForProcessor) {
    //
